...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет заблокированный урон в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Расчитывает урон ультой каждого класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """На основании выбранного класса предлагает провести тренировку.
    Выводит параметры атаки, защиты, ульты или скипает тренировку.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса персонажа и потверждение выбора."""
